...
- (void)setup
{
    ...
    [button runAction:[CCRepeatForever actionWithAction:[CCRotateBy actionWithDuration:2.0f angle:CC_DEGREES_TO_RADIANS(360)]]];
    ...
    [button2 runAction:[CCRepeatForever actionWithAction:[CCRotateBy actionWithDuration:2.0f angle:CC_DEGREES_TO_RADIANS(360)]]];
